...
summary_path = Path("plots_radar_feature_target") / "summary_r2_delta_24h.csv"
...
hdb = HDBSCAN(min_cluster_size=5, min_samples=5, metric="cosine")
...
output_path = Path("gpm_passes_swath_true_hdbscan_delta.csv")
